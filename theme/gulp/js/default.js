...
/**
 * @function `gulp js`
 * @desc Generate `main.js`, `head.js` and `dev.js` by concatenating their dependencies (using `gulp-resolve-dependencies`) and optionally minifying the result (using `uglifyJS`).
 */
