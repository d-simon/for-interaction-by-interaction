...
gulp.task(taskName, function(cb) {
	...
	var getName = function(originalName, type) {
		...
		callback = function(originalName, cb, options) {
			...
			lowerCase = changeCase.lower(name);
			...
			gulp.src(srcPath)
				...
				.pipe(tap(function(file) {
					var content = file.contents.toString()
                            ...
                            .replace(/\{\{snakeCaseName\}\}/g, snakeCase)
                            .replace(/\{\{camelCaseName\}\}/g, camelCase)
                            .replace(/\{\{pascalCaseName\}\}/g, pascalCase)
                            .replace(/\{\{titleCaseName\}\}/g, titleCase)
                            .replace(/\{\{lowerCaseName\}\}/g, lowerCase);
