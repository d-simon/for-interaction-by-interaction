...
;(function($, undefined) {
	...
	SuperClass = function(config) {
		...
		// Save instance
		fibi.modules[this.name].instances[this.uuid] = this;
	...
	SuperClass.prototype.destroy = function() {
		...
		delete fibi.modules[this.name].instances[this.uuid];
	};
	...
	fibi.helpers.initEvents = initEvents;
